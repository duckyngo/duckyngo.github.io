...
#### Tóm tắt luồng công việc với Git-flow:
	...
	8. Nếu có lỗi nghiêm trọng được phát hiện sau khi triển khai, hãy tạo nhánh `hotfix` để sửa lỗi 1 cách khẩn cấp và phân phối phiên bản sửa lỗi ngay lập tức. Nhán `hotfix-` được merge vào nhánh master và nhánh develop ngay sau khi sửa lỗi 
